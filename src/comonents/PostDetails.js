...
const PostDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `${process.env.REACT_APP_BASE_URL}/posts/update/${id}`,
        formData
      );
  ...
  const fetchPostById = async () => {
    try {
      const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/products/single/${id}`);
      console.log("RESppp=>", resp.data.pImage);
      setCategory(resp.data.categoryId.category)
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-control"
                        // {...register("title")}
                        // defaultValue={postData.categoryId.category}
                        value={getCategory}
                        name="categoryId"
                        // onChange={handleChange}
                      />
